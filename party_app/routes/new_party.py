...
def new_party_create_page(
    ...
    return RedirectResponse(request.url_for("party_detail_page", party_id=party.uuid), status_code=status.HTTP_302_FOUND)
...
@router.post(
    "/validate_invitation",
    name="validate_invitation_partial",
